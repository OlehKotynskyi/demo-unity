(() => {
        ...
        open(selectorValue) {
            if (bodyLockStatus) {
                ...
                if (this.targetOpen.element) {
                    ...
                    this._selectorOpen = false;
                    this.isOpen = true;
                    this.targetOpen.element.scrollTop = 0;
                    setTimeout((() => {
                        this._focusTrap();
                        this.targetOpen.element.scrollTop = 0;
                    }), 50);
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (iframes.length === 0) console.log("No iframes found");
        iframes.forEach((iframe => {
            const container = iframe.closest(".video-container");
            const spinner = container.querySelector(".spinner");
            if (!spinner) {
                console.log("Spinner not found in container");
                return;
            }
            console.log("Spinner found, waiting for iframe load");
